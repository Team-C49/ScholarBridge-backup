...
// NOTE: schema trust_registration_requests does NOT have `registration_docs` column.
//       So we DO NOT insert registration_docs here.
//
router.post('/register-request', async (req, res) => {
  try {
    const { org_name, registration_email, contact_phone, contact_email, website, year_established, address, registration_number } = req.body;
    ...
    const sql = `INSERT INTO trust_registration_requests(id, org_name, registration_email, contact_phone, contact_email, website, year_established, address, registration_number, status, submitted_at)
